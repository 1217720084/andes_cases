...
Bus, Vn = 13.8, idx = 13, name = "Bus 13", xcoord = [5.85; 6.6], ycoord = [6.075; 6.075], area = 3
Bus, Vn = 13.8, idx = 14, name = "Bus 14", xcoord = [7.875; 7.275], ycoord = [5.625; 5.625], area = 3
...
Fault, bus = 2, Vn = 69, tf = 2.0, tc = 2.05, rf = 0.0, xf = 0.1
