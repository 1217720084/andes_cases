...
Ground, idx = "Ground_COI", name = "Ground COI", node = "Node_COI_0",
        Vdcn = 193.0, voltage = 0
...
RLs, idx = "RLs_COI_P", name = "RLs Celilo-Sylmarla P", node1 = "Node_COI_1",
     node2 = "Node_COI_2", Vdcn = 193.0, R = 2, L = 0.001
...
C, idx = "C_COI_1", name = "C Celilo P", node1 = "Node_COI_1",
   node2 = "Node_COI_0", Vdcn = 193.0, C = 0.0001
C, idx = "C_COI_2", name = "C Sylmarla P", node1 = "Node_COI_2",
   node2 = "Node_COI_0", Vdcn = 193.0, C = 0.0001
...
VSC, idx = "VSC_Celilo_P", name = "VSC Celilo_P", bus = 70, u = 1,
     node1 = "Node_COI_1", node2 = "Node_COI_0",
     Vn = 230,  rsh = 0.0025, xsh = 0.1, vshmax = 999, vshmin = 0,
     Ishmax = 999, vref0 = 1.00, vdcref0 = 1.0, control = "vV", Vdcn = 193
VSC, idx = "VSC_Sylmarla_P", name = "VSC Sylmarla_P", bus = 59,
     node1 = "Node_COI_2", node2 = "Node_COI_0",
     Vn = 230,  rsh = 0.0025, xsh = 0.1, vshmax = 999, vshmin = 0,
     Ishmax = 999, pref0 = 1, vref0 = 1.03, control = "PV", Vdcn = 193, u = 1
...
VSC1, vsc = "VSC_Celilo_P", name = "VSC Celilo P", Kp1 = 0.1, Ki1 = 0.01,
      Kp2 = 2, Ki2 = 0, Kp3 = 0.01, Ki3 = 0
VSC1, vsc = "VSC_Sylmarla_P", name = "VSC Sylmarla P", Kp1 = 0.1, Ki1 = 0.1,
      Kp2 = 0.1, Ki2 = 0.1, Kp3 = 0.1, Ki3 = 0.1
